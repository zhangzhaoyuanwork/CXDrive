...
$C=$_POST["C"];
$D=$_POST["D"];
$daan=$_POST["daan1"].$_POST["daan2"].$_POST["daan3"].$_POST["daan4"];
include_once("../../peizhi.php");
$zhzc="insert into tiku(timu,leixing,xtdaan,fenshu,shijuanid,yonghuid,a,b,c,d) values('$timu',1,'$daan','$fenshu','$shijuanid','$yhid','$A','$B','$C','$D')";
