...
function goBack(wz) {
  ...
  if(test!=wz+"/yhcz/xs.php"&&test!=wz+"/yhcz/xs_zyz.php"&&test!=wz+"/yhcz/xs_zyzwdgx.php"){window.history.back(-1);}
...
<table class="table table-hover" style="overflow:hidden;">
            ...
            <button class="btn btn-xs btn-secondary" data-toggle="modal" data-target=".bs-example-modal-lg"">搜索</button>
            </th>
                    </tr>
                  </thead>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myLargeModalLabel">请输入您共享的文件名</h4>
                      </div>
                      <div class="modal-body">
                      <input class="form-control" type="text" id="example-text-input" name="example-text-input" placeholder="查找我分享的文件">
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                        <button class="btn btn-primary" name='xj'>搜索</button>
                      </div>
                    </div>
                  </div>
                </div>
...
$zyxt=HSmhcx($zyxt);
$yhwj="select id,wenjianming,wenjianleixing,wenjiandizhi,wenjiandaxiao,gongxiang,xiazaima1 from wenjian where gongxiang=1 and yonghu=$yhid and wenjianming like '$zyxt' limit $qian,20;";
...
<tr>
		...
		<?php
		 ...
		 ?>
            ...
            <button class="btn btn-label btn-purple" onclick="location='gx.php?wjid=<?php echo $row['id'];?>&wjlx=1&gxlx=1'"><label><i class="mdi mdi-lan-disconnect"></i></label>取消共享</button>
