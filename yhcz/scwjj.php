...
$scwjfx="delete from baocunjingxiang where muluid='$wjjid';";$scwjfx1=mysqli_query($lj,$scwjfx);
$scwjbc="delete from jingshijiefenxiang where muluid='$wjjid';";$scwjbc1=mysqli_query($lj,$scwjbc);
