...
$PC=HSpc();
if($_SESSION['quanxian']==1||$_SESSION['quanxian']==2){
?>
<html lang="zh">
<head>
<meta charset="utf-8">
...
<table class="table table-hover" style="overflow:hidden;">
            ...
            <button id="xiayiye" class="btn btn-xs btn-secondary" onclick="location='xs_gly.php?yeshu=<?php echo $_GET['yeshu']+1;?>&&example-text-input=<?php echo $zyxt;?>'">></button>
            <button class="btn btn-xs btn-secondary" data-toggle="modal" data-target=".bs-example-modal-lg"">资源嗅探</button>
            </th>
                    </tr>
                  </thead>
                  <form method='get' action='xs_gly.php'>
...
$jilujishuqi=0;
$zyxt1=HSmhcx($zyxt);
$yhwj="select id,wenjianming,wenjianleixing,wenjiandizhi,wenjiandaxiao,gongxiang,xiazaima1 from wenjian where gongxiang=1 and wenjianming like '$zyxt1' limit $qian,20;";
...
if($jilujishuqi==20){
?>
<button class="btn btn-secondary" style="width:100%" onclick="location='xs_gly.php?yeshu=<?php echo $_GET['yeshu']+1;?>&&example-text-input=<?php echo $zyxt;?>'">前往下一页</button>
<?php
}else{
?>
