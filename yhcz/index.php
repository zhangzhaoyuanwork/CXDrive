...
<div class="lyear-layout-web">
  <div class="lyear-layout-container">
      ...
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="xs.php"  target="xianshi"><i class="mdi mdi-cloud"></i> 全部文件</a> </li>
            ...
            <li class="nav-item active"> <a href="../wjcz/lxsc.html"  target="xianshi"><i class="mdi mdi-cloud-upload"></i> 离线上传</a> </li>
          </ul>
        </nav>
      </div>
	...
	<div class="container-fluid">
      <iframe src="../yhcz/xs.php" width="100%" frameBorder="0" height="100%" scrolling="yes" name="xianshi"/>
	  </div>
      </main>
