...
include_once("../peizhi.php");
		$yhwj="select id,wenjianming,wenjiandizhi,wenjianleixing,gongxiang from wenjian where yonghu=$yhid;";
		$zhixing1=mysqli_query($lj,$yhwj);
		while($row=mysqli_fetch_array($zhixing1)){
			if($row['wenjianleixing']=='mp3'||$row['wenjianleixing']=='wma'||$row['wenjianleixing']=='flac'||$row['wenjianleixing']=='aac'||$row['wenjianleixing']=='mmf'||$row['wenjianleixing']=='amr'||$row['wenjianleixing']=='m4r'||$row['wenjianleixing']=='ogg'||$row['wenjianleixing']=='mp2'||$row['wenjianleixing']=='wav'){
